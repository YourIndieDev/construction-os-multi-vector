...
def require_encryption_key() -> None:
    ...
    if not get_secret_from_env("CONSTRUCTION_OS_ENCRYPTION_KEY"):
        raise ValueError(
            ...
            "Set CONSTRUCTION_OS_ENCRYPTION_KEY to enable storing API keys."
        )
...
async def get_provider_status() -> dict:
    ...
    """
    encryption_configured = bool(get_secret_from_env("CONSTRUCTION_OS_ENCRYPTION_KEY"))
...
async def test_credential(credential_id: str) -> dict:
    ...
    try:
        ...
        from construction_os.ai.connection_tester import (
        ...
        from construction_os.ai.connection_tester import TEST_MODELS
...
async def migrate_from_provider_config() -> dict:
    ...
    from construction_os.domain.provider_config import ProviderConfig
